<%@ Page Title="" Language="C#" MasterPageFile="~/views/customer/FrontEnd.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="GUI.views.customer.Product" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../../contents/cuscss/product.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main_body" runat="server">

    <asp:DataList ID="DataListHang" runat="server" DataKeyField="HangID" RepeatColumns="2">
        <ItemTemplate>
